angular.module('states', [])
  .controller('stateAutocomplete', function($scope) {
    ...
    $scope.filterStates = function() {
      ...
      $scope.filteredStates = $scope.states.filter(function(state) {
        state = state.toLowerCase();
        var lowerCaseInput = $scope.autoCompleteState.toLowerCase();
